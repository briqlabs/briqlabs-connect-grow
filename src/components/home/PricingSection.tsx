    ...
    <section id="pricing" className="py-20 md:py-28 bg-muted/20">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          >
            <p className="text-sm font-medium text-muted-foreground uppercase tracking-wider">Free Trial</p>
            ...
            <Button variant="hero-outline" size="lg" className="w-full mt-6" onClick={() => openForm("Start Free Trial")}>
              Shuru karo free <ArrowRight size={16} />
            </Button>
          ...
          >
            ...
            <div className="mt-3 flex items-baseline gap-2">
              <span className="text-5xl font-display font-extrabold">$29</span>
              <span className="text-muted-foreground">/ month</span>
            </div>
            <p className="text-sm text-muted-foreground mt-2">GST extra · Cancel anytime · Indian invoice</p>
