...
const copy = {
  hinglish: {
    ...
    faq: [
      ...
      ["Setup mein kitna time lagega?", "10 minute. QR scan karo, business info daalo, AI bot activate karo — done."],
  ...
  en: {
    ...
    faq: [
      ...
      ["How long does setup take?", "About 10 minutes. Scan the QR, add your business info, activate the AI bot, and you are done."],
  ...
  hi: {
    ...
    faq: [
      ...
      ["Setup में कितना time लगेगा?", "लगभग 10 मिनट. QR scan करें, business info डालें, AI bot activate करें — done."],
